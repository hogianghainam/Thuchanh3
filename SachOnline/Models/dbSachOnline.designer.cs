...
namespace SachOnline.Models
{
    ...
    partial void OnMatKhauNLChanging(string value);
    partial void OnMatKhauNLChanged();
    ...
    partial void OnTenDNChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MatKhauNL", DbType="NVarChar(50)")]
		public string MatKhauNL
		{
			get
			{
				return this._MatKhauNL;
			}
			set
			{
				if ((this._MatKhauNL != value))
				{
					this.OnMatKhauNLChanging(value);
					this.SendPropertyChanging();
					this._MatKhauNL = value;
					this.SendPropertyChanged("MatKhauNL");
					this.OnMatKhauNLChanged();
				}
			}
		}
